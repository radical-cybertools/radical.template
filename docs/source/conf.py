...
# built documents.
#
# The short X.Y version - get this directly from the package
import radical.###lname###
version = radical.###lname###.version
# The full version, including alpha/beta/rc tags.
release = radical.###lname###.version
...
latex_documents = [
  ('index', 'RADICAL###cname###.tex', u'Radical ###cname### Documentation',
   u'The Radical Group', 'manual'),
]
...
man_pages = [
    ('index', 'radical.###lname###', u'radical.###lname### Documentation',
     [u'The RADICAL Group @ Rutgers'], 1)
]
...
texinfo_documents = [
  ('index', 'RADICAL ###cname###', u'RADICAL ###cname### Documentation',
   u'The RADICAL Group @ Rutgers', 'Radical ###cname###', 'One line description of project.',
   'Miscellaneous'),
]
